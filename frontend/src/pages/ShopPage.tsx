...
const ShopPage = () => {
    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="relative rounded-2xl overflow-hidden mb-6 bg-gradient-to-r from-teal-900 to-slate-900 shadow-lg">
                ...
                <div className="relative p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
                        <span className="px-2.5 py-0.5 rounded-full bg-teal-500/20 text-teal-300 text-[10px] font-bold uppercase tracking-widest border border-teal-500/30 backdrop-blur-sm w-fit">
                            Web3
                        </span>
                        <h2 className="text-lg md:text-xl font-black text-white leading-tight">
                            Unlock <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-400">Digital Wealth</span>
                        </h2>
                    </div>

                    <button className="px-4 py-2 bg-white text-slate-900 rounded-lg font-bold hover:bg-teal-50 transition-colors shadow-lg shadow-white/10 flex items-center gap-2 group text-xs whitespace-nowrap">
                        Explore Assets
                        <ArrowUpRight className="w-3 h-3 text-teal-600 group-hover:scale-110 transition-transform" />
                    </button>
                </div>
            </div>
